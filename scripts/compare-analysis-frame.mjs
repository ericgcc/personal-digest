...
//
//   node scripts/compare-analysis-frame.mjs --replay <run-id> --against <run-id>
//
...
import { ANALYSIS_CLUSTER_KEYS, validateAnalysisSelection, validateFrame } from "../src/editorial/validation/editorial.mjs";
...
if (!replayId || !baselineId) {
  console.error("usage: node scripts/compare-analysis-frame.mjs --replay <run-id> --against <run-id>");
  process.exitCode = 1;
} else {
