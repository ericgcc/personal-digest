...
//
//   node tools/pipeline/verify-corrections.mjs

import { mkdir, rm, writeFile } from "node:fs/promises";
import path from "node:path";

import { ROOT, RUNS_DIRECTORY } from "../lib/shared.mjs";
import { ANALYSIS_EDITORIAL_CODES, validateAnalysisSelection, validateFrame } from "./editorial-validation.mjs";
import { narrativeEvidenceNumbers, catalogProvenanceNumbers } from "./copy-verify.mjs";
import { assembleStageContext, deriveRecoveryFrame, projectEvidence } from "./v2.mjs";
...
try {
  ...
  const { readMeasuredStagesV2 } = await import("./v2.mjs");
...
console.log("\nSee tools/pipeline/phase2-corrections.test.mjs for the assertions behind each line.");
