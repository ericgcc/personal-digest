...
//
//   node tools/pipeline/revalidate-run.mjs --run <run-id> [--profile <profile-id>]
//
...
import { validateAnalysisSelection, validateFrame } from "./editorial-validation.mjs";
...
if (!runId) {
  console.error("usage: node tools/pipeline/revalidate-run.mjs --run <run-id> [--profile <profile-id>]");
  process.exitCode = 1;
} else {
